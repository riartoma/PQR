...
<body>
	...
	<div class="container">
		<div class="content">
			<h2>Datos del PQR &raquo; Editar datos</h2>
			<hr />
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="estado" class="form-control">
                            ...
                            <option value="1" <?php if ($row ['estado']==1){echo "selected";} ?>>Peticion</option>
							<option value="2" <?php if ($row ['estado']==2){echo "selected";} ?>>Queja</option>
							<option value="3" <?php if ($row ['estado']==3){echo "selected";} ?>>Reclamo</option>
						</select> 
					</div>
